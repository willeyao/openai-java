...
public class ChatResultMessage {
    ...
    String content;    //name is optional, The name of the author of this message. May contain a-z, A-Z, 0-9, and underscores, with a maximum length of 64 characters.
    String name;
    @JsonProperty("function_call")
    ChatFunctionCall functionCall;

    public ChatResultMessage(String role, String content) {
        this.role = role;
        this.content = content;
    }

    public ChatResultMessage(String role, String content, String name) {
        this.role = role;
        this.content = content;
        this.name = name;
    }
