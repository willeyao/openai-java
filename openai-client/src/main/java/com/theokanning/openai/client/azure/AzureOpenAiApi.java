...
public interface AzureOpenAiApi {
    ...
    Single<ChatCompletionResult> createChatCompletion(@Path("deployment-id") String deploymentId,
                                                      @Query("api-version") String apiVersion,
                                                      @Body ChatCompletionRequest request);

    @Streaming
    @POST("/openai/deployments/{deployment-id}/chat/completions")
    Call<ResponseBody> createChatCompletionStream(@Path("deployment-id") String deploymentId,
                                                  @Query("api-version") String apiVersion,
                                                  @Body ChatCompletionRequest request);
