    ...
    public static void main(String... args) {
        ...
        while (true) {
            ChatCompletionRequest chatCompletionRequest = ChatCompletionRequest
                    ...
                    .build();
            ChatResultMessage responseMessage = service.createChatCompletion(chatCompletionRequest).getChoices().get(0).getMessage();
            messages.add(new ChatTextMessage(responseMessage.getRole(), responseMessage.getContent())); // don't forget to update the conversation with the latest response
