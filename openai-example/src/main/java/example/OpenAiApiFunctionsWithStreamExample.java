...
public class OpenAiApiFunctionsWithStreamExample {
    ...
    public static void main(String... args) {
        ...
        while (true) {
            ...
            ChatResultMessage chatMessage = service.mapStreamToAccumulator(flowable)
            ...
            messages.add(new ChatTextMessage(chatMessage.getRole(), chatMessage.getContent())); // don't forget to update the conversation with the latest response
